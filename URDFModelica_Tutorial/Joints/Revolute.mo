...
model Revolute
  ...
  URDFModelica_Tutorial.Joints.RotationalFriction dynamic(Rh=jointParams.dynamics.friction, Rv=jointParams.dynamics.damping) if jointParams.hasDynamics annotation (Placement(transformation(
        origin={10,80},
        extent={{-10,10},{10,-10}},
        rotation=-90)));
