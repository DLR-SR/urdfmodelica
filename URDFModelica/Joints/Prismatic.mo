...
model Prismatic
  ...
  replaceable parameter URDFModelica.Records.Joint jointParams
    constrainedby URDFModelica.Records.Joint annotation (Placement(transformation(extent = {{-100, 80}, {-80, 100}})), choicesAllMatching = true);
