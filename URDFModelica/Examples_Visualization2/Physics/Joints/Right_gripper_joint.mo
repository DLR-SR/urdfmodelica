...
model Right_gripper_joint
  extends Modelica.Mechanics.MultiBody.Interfaces.PartialTwoFrames;
  parameter Right_gripper_jointParams jointParams annotation (Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
