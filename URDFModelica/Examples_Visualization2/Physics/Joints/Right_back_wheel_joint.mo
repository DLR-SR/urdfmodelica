...
model Right_back_wheel_joint
  extends Modelica.Mechanics.MultiBody.Interfaces.PartialTwoFrames;
  parameter Right_back_wheel_jointParams jointParams annotation (Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
