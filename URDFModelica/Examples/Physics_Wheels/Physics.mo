within URDFModelica.Examples.Physics_Wheels;
model Physics
...
equation
  ...
  connect(right_front_wheel.frame_a, frame_b[1])
    annotation (Line(points={{70,70},{100,70},{100,-6.85714}}, color = {95, 95, 95}));
  connect(right_back_wheel.frame_a, frame_b[2])
    annotation (Line(points={{70,40},{100,40},{100,-4.57143}}, color = {95, 95, 95}));
  connect(left_front_wheel.frame_a, frame_b[3])
    annotation (Line(points={{70,10},{100,10},{100,-2.28571}}, color = {95, 95, 95}));
  ...
  connect(left_tip.frame_a, frame_b[5])
    annotation (Line(points={{70,-50},{100,-50},{100,2.28571}},  color = {95, 95, 95}));
  connect(right_tip.frame_a, frame_b[6])
    annotation (Line(points={{70,-80},{100,-80},{100,4.57143}},  color = {95, 95, 95}));
  connect(box.frame_a, frame_b[7])
    annotation (Line(points={{20,-110},{100,-110},{100,6.85714}},  color = {95, 95, 95}));
